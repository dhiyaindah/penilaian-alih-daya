...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form method="POST" action="{{ route('penilaian.store', 'keamanan') }}">
                @csrf
                <input type="hidden" name="next_section" value="sopir">
                <input type="hidden" name="current_section" value="keamanan">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-12 mb-4">
                        <h5 class="fw-bold mb-3 text-center">Bidang keamanan</h5>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="keamanan_{{ $pegawai->id }}_{{ $i }}">
                                                                {{ $i }}
                                                            </label>
                                                        </div>
                                                        @endfor
